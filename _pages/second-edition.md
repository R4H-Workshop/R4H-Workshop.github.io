...
| **Article Title**                                                                                                        | **Time**                 |
|--------------------------------------------------------------------------------------------------------------------------|
| Emotion-Adaptive Human–Robot Collaboration for Elderly Care in Ageing Societies                                          | 
| Personalised Serious Games with Humanoid Robots for Older Adults Cognitive Training                                      | 
| Empowering Neurodiversity: Rethinking interaction with children with Autism Spectrum Disorder through robotic mediation  | 
| Designing Robots with, not for: A Co-Design Framework for Empowering Interactions in Forensic Psychiatry                 | 
| Co-designing Stress Management Social Robots: Methodological Insights and Future Directions                              | 
...
| Welcome Aboard! Envisioning an employment negotiation within a social robot from the users’ perspective                  |
| Expectation vs. Reality: Perceptions of Social Robots                                                                    |
| Lessons Learned Co-Creating Robot Study Companions using the Double Diamond                                              |
